    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        <img class="rounded-circle" src="https://api.adorable.io/avatars/285/abott@adorable.png" alt=""
          style="height: 32px;">
        <a class="p-2 text-dark" href="#"><?=htmlspecialchars($_SESSION['name'])?></a>
      </nav>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?=htmlspecialchars($value['poster']);?></td>
            <td>
            <?php
            switch($value['type']) {
              case '1':
            ...
            <td><?=htmlspecialchars($value['reporter']);?></td>
            <td>
              <a href="./?page=admin&action=approve&id=<?=$value['id']?>">Approve</a>
              <a class="text-danger" href="./?page=admin&action=reject&id=<?=$value['id']?>">Reject</a>
            </td>
          </tr>
          <?php
          }
