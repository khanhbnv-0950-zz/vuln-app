  ...
  <body>
    <form class="form-signin" method="post">
      ...
      <div class="checkbox mb-3">
        <label>
          <input type="checkbox" name="remenber-me" value="remember-me"> Remember me
        </label>
      </div>
...
if ($_SESSION['flag'] == 0 ) {
  if ($_SESSION['isAdmin'] == 0){
    printf("<script>alert(\"%s\");\nwindow.location.replace(\"http://localhost/vuln-app/?page=home\");</script>", $_SESSION['msg']);
  } else {
    printf("<script>alert(\"%s\");\nwindow.location.replace(\"http://localhost/vuln-app/?page=admin\");</script>", $_SESSION['msg']);
  }
