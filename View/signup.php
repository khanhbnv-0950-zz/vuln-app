...
<html lang="en">
  ...
  <body>
    <form class="form-signin" method="post">
      ...
      <input name="name" id="inputName" class="form-control" placeholder="Name" required autofocus>
      ...
      <input type="password" name="re_password" id="inputPassword" class="form-control" placeholder="Confirm Password" required>
...
<?php
if ($_SESSION['flag'] == 0) {
  printf("<script>alert(\"%s\");\nwindow.location.replace(\"http://localhost/vuln-app/?page=signin\");\n</script>", $_SESSION['msg']);
} else if ($_SESSION['flag'] > 0){
  printf("<script>alert(\"%s\")</script>", $_SESSION['msg']);
}
?>
  </body>
